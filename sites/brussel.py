...
systems = [
    {
        ...
        'partitions': [
            ...
            },
            {
                ...
                'descr': 'default-node jobs (zen4, no InfiniBand)',
                'max_jobs': 20,
                'launcher': 'local',
            ...
            },
            {
                ...
                'access': ['-p hopper_gpu'],
                'environs': ['CUDA', 'standard'],
                'descr': 'Nvidia H200 nodes',
                'max_jobs': 10,
                'launcher': 'local',
                'resources': _gpu_resources,
                'features': ['gpu', 'nvidia'],
                'extras': {'num_cpus': 48, 'num_gpus': 2},
            },
        ]
    },
    {
